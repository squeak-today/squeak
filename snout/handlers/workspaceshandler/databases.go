...
func (h *WorkspacesHandler) CreateDatabase(c *gin.Context) {
	...
	databaseId, err := workspaces.CreateDatabase(h.DBClient, userId, workspaceId, request.Name)
	if err != nil {
...
//	@Failure		400				{object}	models.ErrorResponse
//	@Failure		500				{object}	models.ErrorResponse
//	@Router			/workspaces/{workspace_id}/databases/{database_id}/query [get]
...
//	@Failure		400				{object}	models.ErrorResponse
//	@Failure		500				{object}	models.ErrorResponse
//	@Router			/workspaces/{workspace_id}/databases/{database_id} [delete]
func (h *WorkspacesHandler) DeleteDatabase(c *gin.Context) {
	userId := h.GetUserIDFromToken(c)
	workspaceId := c.Param("workspace_id")
	databaseId := c.Param("database_id")
	...
	c.JSON(http.StatusOK, workspaces_models.DeleteDatabaseResponse{})
}
