...
func CreateEvaluateQNAPrompt(cefr string, content string, question string, answer string) string {
	...
	sb.WriteString("\n\nAnswer with ONLY PASS or FAIL. Do NOT add any other preamble or comment. If the CEFR level is A1-A2, Allow passes more genourously as the user's are beginners")
