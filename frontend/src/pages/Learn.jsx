            ...
            <BrowserBox>
                <LearnPageLayout>
                    <StoryBrowserContainer>
                        ...
                        <TabsContainer>
                            <Tab isActive={activeTab === 'today'} onClick={() => setActiveTab('today')}>
                                Today
                            </Tab>
                            <Tab isActive={activeTab === 'search'} onClick={() => setActiveTab('search')}>
                                Search
                            </Tab>
                            <Tab isActive={activeTab === 'decks'} onClick={() => setActiveTab('decks')}>
                                Decks
                            </Tab>
                        </TabsContainer>
                        {activeTab === 'today' && (
